...
class environment :
    object
        val types : ty symbol_table
        val declarations : declaration symbol_table

        method add_declaration : string -> declaration -> unit
        method add_type : string -> ty -> unit
        method enter_scope : unit
        method leave_scope : unit
